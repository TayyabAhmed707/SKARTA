...
public class Ahsan extends Player
{
    ...
    {
        if (!isSlime && specialAbility)
        {
            g.drawImage(attack[attackCycle][specialFrameCount / 2], displayXcor - 60, displayYcor - 90, null);
        }
    }
    ...
    static void setSlime(boolean isSlisme)
    {
        Ahsan.isSlime = isSlisme;
    }
